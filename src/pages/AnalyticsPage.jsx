...
function AnalyticsPage() {
  ...
  return (
    <DashboardLayout>
      ...
      <div className="mt-6 p-5 bg-gradient-to-br from-indigo-600 to-blue-700 text-white rounded-xl">
        <div className="flex items-start gap-4">
          <div className="w-10 h-10 bg-indigo-500/30 rounded-xl flex items-center justify-center border border-indigo-400/30 shadow-inner flex-shrink-0">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-6 h-6 text-white"><path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09l2.846.813-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.894 20.567L16.5 21.75l-.394-1.183a2.25 2.25 0 00-1.423-1.423L13.5 18.75l1.183-.394a2.25 2.25 0 001.423-1.423l.394-1.183.394 1.183a2.25 2.25 0 001.423 1.423l1.183.394-1.183.394a2.25 2.25 0 00-1.423 1.423z" /></svg>
          </div>
          <div>
            <h3 className="font-bold mb-2">AI-Powered Insights (Coming Soon)</h3>
            <p className="text-indigo-100 text-sm leading-relaxed mb-3">
              In the next version, AI will analyze your ticket patterns and provide
              actionable recommendations like:
            </p>
            <ul className="text-indigo-200 text-sm space-y-1">
              <li>• "Billing tickets spike on weekends - consider weekend support coverage"</li>
              <li>• "High priority tickets take avg. 4.2 hours to resolve - target is under 2 hours"</li>
              <li>• "23% of tickets are duplicates - create an FAQ to reduce volume"</li>
            </ul>
          </div>
        </div>
      </div>
